...
const caseStudiesData = [
  {
    ...
    system: "AI lead scoring engine + n8n workflow that captures form submissions, enriches lead data, scores based on firmographic and behavioral signals, and routes qualified leads to the appropriate account manager via Slack and CRM updates.",
  ...
  },
  {
    ...
    system: "n8n workflow that triggers when a cart is abandoned, uses AI to generate personalized product recommendations and discount offers, and sends a multi-email sequence with increasing urgency and value.",
